    ...
    return (
        <section className="relative m-4 rounded-xl flex min-h-screen items-center justify-center overflow-hidden">
            ...
            <div className="relative z-10 mx-auto max-w-4xl px-6 text-center md:mt-12 text-white">
                ...
                {/* Social proof */}
                <div className="mx-auto mb-8 flex w-fit items-center gap-3 rounded-full bg-white/90 backdrop-blur px-4 py-2 shadow-sm">
                ...
                {/* Heading */}
                <h1 className="text-5xl md:text-7xl font-medium leading-[1.15] tracking-[-0.02em]">
